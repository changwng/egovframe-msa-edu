package org.egovframe.cloud.cmsservice.utils;
...
import org.egovframe.cloud.cmsservice.api.attachment.dto.AtflMngImageResponseDto;
...
import org.egovframe.cloud.cmsservice.utils.FtpClientDto;
...
import static org.egovframe.cloud.cmsservice.utils.PortalUtils.getPhysicalFileName;
...
//                        String remote = "/mnt/messages/" + file.getName();
     ...
     * @return
     */
    public String storeBase64File(AtflMngBase64RequestDto requestDto, String basePath) {
        try {
            // ftp connect
            FtpClientDto ftpClientDto = new FtpClientDto(environment);
            this.connect(ftpClientDto);
...
//            FileOutputStream outputStream = new FileOutputStream(file);
     ...
     * @return
     */
    public String storeBase64File(AtflMngBase64RequestDto  requestDto) {
